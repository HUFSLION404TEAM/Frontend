...
export default function PortfolioAwardsPage() {
  ...
  useEffect(() => {
    ...
    const finalAwards = passedData.awards || [
        { id: 1, name: '전국 대학생 UI/UX 디자인 공모전', type: '금상' },
        { id: 2, name: '대학생 디지털 마케팅 아이디어 경진대회', type: '동상' },
        { id: 3, name: '캠퍼스 브랜드 해커톤', type: '장려상' },
        { id: 4, name: '캠퍼스 브랜드 해커톤', type: '장려상' },
    ];
        ...
        <div style = {frameStyle}>
            ...
            <main style={mainContentStyle}>
              ...
              <section style={detailSectionStyle}>
                <h3 style={detailTitleStyle}>Awards</h3>
