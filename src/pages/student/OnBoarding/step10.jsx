            ...
            <main style = {mainContentStyle}>
              <div style = {questionContainerStyle}>
                <h2 style = {mainQuestionStyle}>
                  기획자님을<br />
                  <span style = {{color: '#0080FF' }}>경력 및 프로젝트</span>
                  를 입력해주세요!
                </h2>
              ...
              <div style = {inputSubcontainerStyle}>
                <span style = {inputPlaceHolderStyle}>수상경력 및 프로젝트</span>  
                <button style = {nextIconStyle}><NextIcon/></button>
              </div>
