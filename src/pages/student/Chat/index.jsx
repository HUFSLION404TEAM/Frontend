...
const SAMPLE = [
  { id: 1, name: '컴포즈커피 외대점', preview: '감사합니다!', timeLabel: '오전 11:09', unread: 1 },
  { id: 2, name: '메가커피 외대점', preview: '최종본 전달 드립니다!', timeLabel: '오전 10:07', unread: 1 },
  { id: 3, name: '컴포즈커피 외대점', preview: '감사합니다!', timeLabel: 'Yesterday', unread: 1 },
  { id: 4, name: '메가커피 외대점', preview: '감사합니다!', timeLabel: '오전 11:09', unread: 12 },
  { id: 5, name: '컴포즈커피 외대점', preview: '감사합니다!', timeLabel: '오전 11:09', unread: 0 },
  { id: 6, name: '메가커피 외대점', preview: '감사합니다!', timeLabel: '오전 11:09', unread: 7 },
];
...
export default function ChatStudent() {
  ...
  const onOpenRoom = (item) =>
    navigate(`/student/chat/${item.id}`, { state: { peerName: item.name } });
