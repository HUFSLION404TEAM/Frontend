...
import ModalStudent from '../../student/Notice/Components/Modal';
import ProfileModalStudent from './Components/ProfileModal';
    ...
    <Page>
      <Wrap>
        ...
        <ModalStudent open={open} onClose={() => setOpen(false)}>
          <ProfileModalStudent data={selected} />
        </ModalStudent>
      </Wrap>
    </Page>
  );
