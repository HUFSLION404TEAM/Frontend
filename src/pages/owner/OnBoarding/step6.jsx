...
export default function OnboardingIntroPage() {
  ...
  const address = location.state?.address || '업체 주소를 입력하세요';
  const phoneNumber = location.state?.phoneNumber || '업체 연락처를 입력하세요';
  const businessId = location.state?.businessId || '사업자번호를 입력하세요';
            ...
            <main style = {mainContentStyle}>
              <div style = {questionContainerStyle}>
                <h2 style = {mainQuestionStyle}>
                  가게의<br />
                  <span style = {{color: '#0080FF' }}>소개</span>
                  를 입력해주세요!
                </h2>
